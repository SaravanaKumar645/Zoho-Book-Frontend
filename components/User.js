...
import { getId } from "../services/Customers";
                    ...
                    <Item>
                      ...
                      <Grid xs={10}>
                        ...
                        >
                          ...
                          <Typography variant="body2" gutterBottom>
                            <p>
                              Client Portal allows your customers to keep track
                              of all the transactions between them and your
                              business. Learn More
                            </p>
                          </Typography>
                        </Item>
                      ...
                      <div style={{ display: "flex" }}>
                        <div style={{ padding: "5px 20px 20px 30px" }}>
                          <Typography variant="body2" gutterBottom>
                            ...
                            <p style={{ fontSize: "20px", color: "#e65c00" }}>
                              <b>Rs.{cur}.00</b>
                            </p>
