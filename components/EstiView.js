...
function EstiView({ estid }) {
  ...
  console.log(estid);
  useEffect(async () => {
    await getSingleEsti(estid).then((data) => {
      if (data) {
        console.log("Inside ESTView : Success---");
        console.log(data);
        setEstimateDate(data.estimate_date);
        setExpiryDate(data.expiry_date);
        setReference(data.reference);
        setCustomerName(data.customer_name);
        setName(data.items.length > 0 && data.items[0].name);
        setQuantity(data.items.length > 0 && data.items[0].quantity);
        setAmount(data.items.length > 0 && data.items[0].amount);
                ...
                <Grid container spacing={0}>
                  ...
                  >
                    ...
                    >
                      ...
                      <th>
                        <h2 style={{ padding: "10px" }}>ESTIMATE</h2>
                      </th>
                    </tr>
              ...
              <form onSubmit={handleSubmits}>
                ...
                >
                  ...
                  <input
                    ...
                    value="techpiratesteam@gmail.com"
                  />
                </div>
                <div
                  class="form-group"
                ...
                >
                  ...
                  <input
                    ...
                    class="form-control"
                    id="exampleFormControlInput1"
                    placeholder="Account Statement from 01/11/2021 to 30/11/2021"
                  />
                </div>
                <div
                  class="form-group"
